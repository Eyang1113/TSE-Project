            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  schedule where ambid=$userid;");
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,ambulance.ambname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join ambulance on schedule.ambid=ambulance.ambid where ambulance.ambid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Ambulance Name from the list</option><br/>';
                                        ...
                                        $list11 = $database->query("SELECT * FROM ambulance WHERE ambname='$username' ;");
