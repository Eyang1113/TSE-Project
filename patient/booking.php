                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search ambulance name or Email or Date (YYYY-MM-DD)" list="ambulances" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join ambulance on schedule.ambid=ambulance.ambid where schedule.scheduleid=$id  order by schedule.scheduledate desc";
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            ambulance name:  &nbsp;&nbsp;<b>'.$ambname.'</b><br>
                                                            ambulance Email:  &nbsp;&nbsp;<b>'.$ambemail.'</b> 
                                                        </div>
