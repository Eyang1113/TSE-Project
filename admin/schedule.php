...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <td width="30%">
                        <select name="ambid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Ambulance Name from the list</option><br/>
                                
                            <?php 
                            
                                $list11 = $database->query("select  * from  ambulance order by ambname asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlpt2="";
                        if(!empty($_POST["ambid"])){
                            $ambid=$_POST["ambid"];
                            $sqlpt2=" ambulance.ambid=$ambid ";
                        }
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,ambulance.ambname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join ambulance on schedule.ambid=ambulance.ambid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,ambulance.ambname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join ambulance on schedule.ambid=ambulance.ambid  order by schedule.scheduledate desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="ambid" class="form-label">Select Ambulance: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="ambid" id="" class="box" >
                                    <option value="" disabled selected hidden>Choose Ambulance Name from the list</option><br/>';
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="time" class="form-label">Schedule Time Start: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,ambulance.ambname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join ambulance on schedule.ambid=ambulance.ambid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $ambname=$row["ambname"];
            $scheduleid=$row["scheduleid"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Ambulance of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
